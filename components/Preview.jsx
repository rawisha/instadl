...
import { Heart, MessageCircle, Send, Bookmark, Download } from "lucide-react";
...
const Preview = () => {
  ...
  const handleDownload = async () => {
    ...
    const filename = `${userData.username}_${
    ...
    try {
      const response = await axios.get(
        isVideo
          ? url
          : `/api/instagram/download?url=${encodeURIComponent(url)}`,
        {
      ...
      <div className="flex">
            ...
            <>
              <div className="relative w-full h-auto md:h-auto">
                ...
                <button
                  ...
                  className="absolute top-4 right-4 z-10 p-3 bg-green-600 rounded-full text-white"
        ...
        <div className="md:w-1/2 mr-5 bg-black text-white p-4 hidden md:block">
          ...
          <div className="mb-4 max-w-sm">
            <span className="font-bold">{userData.username}</span> Feel free to
            download your own content at www.instadl.com 🤯 @eric_szk
            @mehdi_amri_10
          </div>
